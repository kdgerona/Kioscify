...
class ApiClient {
  ...
  async updateStore(storeId: string, payload: { name?: string; enabledDeliveryPlatforms?: string[]; priceTierId?: string | null; menuId?: string | null; inventorySetupId?: string | null }): Promise<Store> {
