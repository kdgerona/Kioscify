...
export default function TenantSetup() {
  ...
  const handleBarCodeScanned = async ({ data }: { data: string }) => {
    ...
    try {
      ...
      setScanError(
        "Could not read QR code. Please try again or use manual entry below.",
      );
    }
  };
  ...
  const formContent = (
    <>
      ...
      >
        ...
        <Text style={{ marginHorizontal: 10, fontSize: 11, color: "#9ca3af" }}>
          or enter manually
        </Text>
        <View style={{ flex: 1, height: 1, backgroundColor: "#e5e7eb" }} />
      </View>
      ...
      <TouchableOpacity
        ...
        disabled={
          loading || !slug.trim() || !companySlug.trim() || !brandSlug.trim()
        }
        style={{
          backgroundColor:
            loading || !slug.trim() || !companySlug.trim() || !brandSlug.trim()
  ...
  if (isLandscape) {
    return (
      <View style={{ flex: 1, flexDirection: "row" }}>
        ...
        <View
          style={{ width: "40%", backgroundColor: ORANGE, overflow: "hidden" }}
        >
          {/* Decorative rings */}
          <View
            style={{
    ...
    <AppSafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
        ...
        >
          ...
          <View style={{ width: "100%" }}>{formContent}</View>
        </View>
      </KeyboardAwareScrollView>
    </AppSafeAreaView>
  );
