      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-10 bg-white">
        ...
        <div className="w-full max-w-sm">
          ...
          <button
            type="button"
            onClick={() => api.logout()}
            className="w-full mt-4 py-3 rounded-xl text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition"
          >
            Cancel
          </button>

          <div className="flex items-center justify-center gap-2 mt-6 bg-white border border-gray-200 rounded-full px-3 py-1.5 w-fit mx-auto">
            {/* eslint-disable-next-line @next/next/no-img-element */}
