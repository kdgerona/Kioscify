  ...
  return (
    <div className="p-6 flex items-center justify-center min-h-96">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Categories Managed at Brand Level</h2>
        <p className="text-gray-600 text-sm">
          Product categories are now managed in the Company &amp; Brand Portal by your brand manager.
        </p>
