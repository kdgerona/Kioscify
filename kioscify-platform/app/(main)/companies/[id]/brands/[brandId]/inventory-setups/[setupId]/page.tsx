  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-center gap-3">
        <Link href={`/companies/${companyId}/brands/${brandId}?tab=inventory-setups`} className="text-gray-400 hover:text-gray-600">
          <ChevronLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{setup.name}</h1>
          <p className="text-sm text-gray-500">
            <Link href={`/companies/${companyId}/brands/${brandId}?tab=inventory-setups`} className="hover:underline">← Back to Inventory Setups</Link>
          </p>
        </div>
      </div>
